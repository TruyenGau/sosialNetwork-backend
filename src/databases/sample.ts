...
export const INIT_PERMISSIONS = [
  ...
  {
    _id: '648ab750fa16b294212e404d',
    name: 'Upload multiple File',
    apiPath: '/api/v1/files/upload-media',
    method: 'POST',
    module: 'FILES',
    createdBy: {
      _id: '68f5bdcce9cfdc5704297efe',
  ...
  {
    _id: '648ad622dafdb9754f40b87f',
    name: 'Fetch posts with paginate',
    apiPath: '/api/v1/posts',
    method: 'GET',
    module: 'POSTS',
    createdBy: {
